...
describe('AboutComponent', () => {
  it('deve exibir o título e subtítulo corretamente', () => {
    ...
    cy.get('.title h1').should('contain.text', 'Na Truck Me, somos especialistas em fretes.');

    cy.get('.subtitle').should('contain.text', 'Uma startup que oferece soluções inovadoras para conectar embarcadores e transportadores de maneira eficiente e transparente de forma 100% digital.');
  });
